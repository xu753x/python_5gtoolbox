...
"""the script is used to simulate hard-decision BF LDPC decoder performance
it support [ 'BF'] algorithms
'BF': Bit Flipping
"""
...
L_list = [16, 32, 64] #ldpc decoder iteration number

#simulation config
snr_db_list = np.arange(2, 6, 0.5).tolist()
test_count_seed = 200 #used to generate total test count for each snr
filename = "out/ldpc_decode_result_BF.pickle" #test result save to this file
figfile = "out/ldpc_decode_result_BF.png"     #plt draw figure saveto this file
        ...
        for test_idx in range(test_num):
            ...
            for snr_db in snr_db_list:
                ...
                if snr_db < 4:
                    ...
                    total_count = test_count_seed * 10
