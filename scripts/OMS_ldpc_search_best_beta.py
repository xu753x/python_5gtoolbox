...
""" the script is to search best beta value for offset min-sum LDPC decoder
"""

#5G LDPC config, Zc and bgn
#Zc_list = [2, 12 ,28, 40, 72, 176, 208,384]  # Z value in 38.211 Table 5.3.2-1: Sets of LDPC lifting size Z
Zc_list = [12 ,28, 40, 72, 176, 208]  # Z value in 38.211 Table 5.3.2-1: Sets of LDPC lifting size Z
...
search_beta_list = [0.1,0.3,0.5,0.7,0.9] #
...
filename_pre = "out/OMS_search_beta_" #test result save to this file
figfile_pre = "out/OMS_search_beta_"     #plt draw figure saveto this file
...
for Zc in Zc_list:
    for bgn in bgn_list:
        ...
        if sim_flag == 1:
            sim_ldpc_internal.run_ldpc_simulation(Zc, bgn, crcpoly, algo_list,alpha_list,search_beta_list,mixed_list,
