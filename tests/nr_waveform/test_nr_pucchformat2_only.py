...
def test_nr_pucchformat2_only(filename):
    #read data
    matfile = io.loadmat(filename)
    codeword_out, symbols_out, ref_fd_slot_data, pucchformat2_tvcfg = \
    ...
    pucch_format2_config_list.append(pucch_format2_config)
