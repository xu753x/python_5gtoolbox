...
def test_nr_prach_waveform(filename):
    ...
    td_waveform, prach_data_list = nr_prach_waveform.gen_prach_waveform( \
        waveform_config,carrier_config,prach_config,prach_parameters)
    prach_data = prach_data_list[0,:]
    #compare
