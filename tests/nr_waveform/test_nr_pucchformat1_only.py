...
def test_nr_pucchformat1_only(filename):
    #read data
    matfile = io.loadmat(filename)
    codeword_out, symbols_out, ref_fd_slot_data, pucchformat1_tvcfg = \
    ...
    pucch_format1_config_list.append(pucch_format1_config)
