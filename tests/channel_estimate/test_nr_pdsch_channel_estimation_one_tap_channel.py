...
def get_channel_parameter_list():
    ...
    #model_format      channel, Timeoff_ns,        rho, fm_inHz, fDo_in_Hz,      K,       [alha,beta] for MIMO spat
        ...
        ["customized", "Rayleigh",  0,           0,   0,      0,       0,       [0,0] ],
        ["customized", "Rayleigh",  0,           0,   0,      0,       0,       [0.3,0.3] ],
        ["customized", "Rayleigh",  0,           0,   0,      0,       0,       [0.3,0.9] ],
        ["customized", "Rayleigh",  0,           0,   0,      0,       0,       [0.9,0.9] ],
        ["customized", "Rayleigh",  20,          0,   200,    0,       0,       [0,0] ],
        ["customized", "Rayleigh",  200,         0,   400,    0,       0,       [0.3,0.3] ],
        ["customized", "Rician",    0,           0,   0,      100,     10,       [0,0] ],
        ["customized", "Rician",    0,           0,   0,      100,     10,       [0.3,0.3] ],
        ["customized", "Rician",    0,           0,   0,      100,     10,       [0.3,0.9] ],
        ["customized", "Rician",    25,          0,   300,    200,     13,       [0,0] ],
        ["customized", "Rician",    0,           0,   400,    300,     13,       [0,0] ],
        ]
    Pnoise_dB_list = [-20] #[-30] #
...
def test_nr_pdsch_channel_est_single_tap(pdsch_carrier_testvectors, channel_parameter,CEQ_algo,CE_config):
    """ test PDSCH channel estimation 
     low correlation, "Rayleigh", maximum doppler freq = 0, time-non-changable channel
    """
    ...
    if status:
        print(f"pass en TO comp,mcsidx{mcs_index},Nt{Nt},Nr{Nr}, {CE_algo}, {freq_intp_method}, Timeoff_ns{Timeoff_ns},fDo_in_Hz{fDo_in_Hz},alpha{alpha},beta{beta},Elapsed Time: {elapsed_time:.2f} seconds,TO_est{TO_est*10**9:.2f}ns,H_est_power={H_est_power}dB, cov_m_power={cov_m_power}dB")
    else:
