...
def gen_mimo_channel(Nt, Nr, R_spat, N, samplerate_in_hz,channel, K, fDo,fmax=0,num_of_sinusoids=50):
    ...
    #step 1, generate Nt X Nr Rayleigh or Rician with size = N
...
if __name__ == "__main__":
    ...
    MIMO_channel = gen_mimo_channel(Nt, Nr, R_spat, N=10, samplerate_in_hz=245760000,channel="Rayleigh", K=0, fDo=0,fmax=0,num_of_sinusoids=50)
